...
public abstract class MetadataMockResponseList extends MockResponseList {
    ...
    public MetadataMockResponseList(IFileReader fileReader) throws IOException {
        ...
        addFileResponse(getProgramsWithAccessMockResponse());
        ...
        addFileResponse(getDataSetsWithAccessMockResponse());

        addFileResponse(getDataSetsMockResponse());

        addFileResponse(getDataElementsMockResponse());

        addFileResponse(getIndicatorsMockResponse());

        addFileResponse(getIndicatorTypesMockResponse());
    ...
    protected abstract String getProgramsWithAccessMockResponse();
    ...
    protected abstract String getDataSetsWithAccessMockResponse();

    protected abstract String getDataSetsMockResponse();

    protected abstract String getDataElementsMockResponse();

    protected abstract String getIndicatorsMockResponse();

    protected abstract String getIndicatorTypesMockResponse();
